<div align="center">
  ...
  <img src="images/Maior%20de%20Minas%20Trofeus.png" height="1.3" />
</div>
...
2. Download the latest `Power-Show-Desktop-1.3.plasmoid` file.
3. To install, you can double-click the downloaded file and use the KDE installer, or use the terminal:
   ```bash
   kpackagetool6 -i Power-Show-Desktop-1.3.plasmoid
   ```
